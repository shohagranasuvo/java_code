...
public class GameRockPaperScissors {
    static
{
    System.out.println("Now It's time for a Game \nHere are 5 round game of RockPaperScissors between you and me \nLet's Start \n \n \n" );
}
    ...
    public static void main(String[] args) {
        ...
        while (test!=0)
        {
           ...
           if (choice>= 1  && choice<= 3 )
           {
            ...
            System.out.println("\nYour input invalid .Because it's not a digit.\n");
            test++;
            count--;
        }}
           ...
           {
            System.out.print("You win "+myWin +" times.I won "+computerWin+" time");
           if (computerWin>1)
           {
            System.out.println("s \n");
           }
